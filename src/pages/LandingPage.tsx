...
export default function LandingPage() {
  const sendContactEmail = async (payload: Record<string, string>) => {
    const res = await fetch(`https://phoepkacbrtolqmlwkvw.supabase.co/functions/v1/send-contact-email`, {
      method: "POST",
      headers: { "Content-Type": "application/json", apikey: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBob2Vwa2FjYnJ0b2xxbWx3a3Z3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA2MDUxMjcsImV4cCI6MjA3NjE4MTEyN30.ZtrCsy3ReW0ctykXqt9YWy14oevyzWZSdYALYPDX8fo" },
